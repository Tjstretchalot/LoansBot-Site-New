...
if($_SERVER['REQUEST_METHOD'] === 'GET') {
  ...
  if($modify === 1) {
    ...
    $query .= ') ';
    $query .= 'SELECT ';
    $query .=   'old_info.loan_id, ';
    $query .=   '?, ';
    $query .=   '?, ';
    $query .=   'outer.old_lender_id, ';
    $query .=   'outer.old_borrower_id, ';
    $query .=   'outer.old_principal_cents, ';
    $query .=   'outer.old_principal_repayment_cents, ';
    $query .=   'outer.old_unpaid, ';
    $query .=   'outer.old_deleted, ';
    $query .=   'outer.old_deleted_reason, ';
    $query .=   'outer.new_lender_id, ';
    $query .=   'outer.new_borrower_id, ';
    $query .=   'outer.new_principal_cents, ';
    $query .=   'outer.new_principal_repayment_cents, ';
    $query .=   'outer.new_unpaid, ';
    $query .=   'outer.new_deleted, ';
    ...
    $query .=   'SELECT ';
    $query .=     'loan_id, ';
    $query .=     'loan_lender_id as old_lender_id, ';
    $query .=     'loan_borrower_id as old_borrower_id, ';
    $query .=     'loan_principal_cents as old_principal_cents, ';
    $query .=     'loan_principal_repayment_cents as old_principal_repayment_cents, ';
    $query .=     'loan_unpaid as old_unpaid, ';
    $query .=     'loan_deleted as old_deleted, ';
    $query .=     'loan_deleted_reason as old_deleted_reason ';
    ...
    $query .=      'principal_repayment_cents as new_principal_repayment_cents, ';
    $query .=      'unpaid as new_unpaid, ';
    $query .=      'deleted as new_deleted, ';
