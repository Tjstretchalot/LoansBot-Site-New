...
if($_SERVER['REQUEST_METHOD'] === 'GET') {
  ...
  if($modify === 1) {
    ...
    $query .=   '?, ';
    $query .=   '?, ';
    $query .=   'oute.old_lender_id, ';
    $query .=   'oute.old_borrower_id, ';
    $query .=   'oute.old_principal_cents, ';
    $query .=   'oute.old_principal_repayment_cents, ';
    $query .=   'oute.old_unpaid, ';
    $query .=   'oute.old_deleted, ';
    $query .=   'oute.old_deleted_reason, ';
    $query .=   'oute.new_lender_id, ';
    $query .=   'oute.new_borrower_id, ';
    $query .=   'oute.new_principal_cents, ';
    $query .=   'oute.new_principal_repayment_cents, ';
    $query .=   'oute.new_unpaid, ';
    $query .=   'oute.new_deleted, ';
    $query .=   'oute.new_deleted_reason, ';
    $query .=   'NOW() as now1, ';
    $query .=   'NOW() as now2 ';
    $query .= 'FROM ';
    $query .= '(';
