    ...
    <section>
      ...
      <form id="create-account-form">
        <div class="form-group row">
          <input type="text" class="form-control" id="username" aria-label="Username" placeholder="Username" aria-describedby="usernameHelpBlock" <?php if (isset($_GET['username'])) {
        ...
        <div class="form-group row">
          <input type="text" class="form-control" id="token" aria-label="Token" placeholder="Token" aria-describedby="tokenHelpBlock" <?php if (isset($_GET['claim_code'])) {
                                                                                                                                        echo 'value="' . htmlspecialchars($_GET['claim_code']) . '"';
                                                                                                                                      } ?> required>
