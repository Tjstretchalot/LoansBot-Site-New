<?php
    // This endpoint can be included as the index page for directories that
    // should not typically be accessed
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container px-2 py-5">
      <section>
        <h1>Directory Listing Blocked</h1>
        <p>Hello! You have accessed the index page of a directory which is not meant to be used
